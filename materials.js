...
const MATERIALS = [
  ...
  {
    course: '울산과학대학교 교직원 AI 활용 워크샵',
    title:  '울산과학대학교 교직원 AI 활용 교육 — 젠스파크 제작 자료',
  ...
  /* ── 바이브코딩으로 직접 만든 실습 도구 ── */
  {
    ...
    type:   '웹',
    url:    'files/eduhee_editor.html',
    date:   '2026.07',
  },

  {
    course: '🛠 직접 만든 AI 도구 (바이브코딩)',
    title:  'EduHee Cut — 웹 영상 편집기 (Genspark 제작)',
    desc:   '젠스파크로 만든 영상 편집기. 자막·BGM·전환효과·필터 지원. 클릭하면 새 창에서 열립니다. (Chrome/Edge 권장)',
    type:   '웹',
  ...
  /* ── 영상 실습 자료 (쇼츠 만들기) ── */
  {
    ...
    title:  '울산과학대 홍보영상 (완성 예시)',
    tag:    '7.23. 실습 자료',
    desc:   'AI로 만든 울산과학대 홍보 쇼츠 완성본. 클릭하면 새 창에서 재생됩니다. 이런 영상을 아래 소스로 직접 만들어 볼 수 있어요.',
    type:   '영상',
    url:    'files/usc_promo_2026.mp4',
    date:   '2026.07',
  },
